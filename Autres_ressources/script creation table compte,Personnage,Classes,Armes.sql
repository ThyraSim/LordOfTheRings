...
INSERT INTO Classes (nom_classe,puissance,agilete,constitution,intelligence) VALUES
                                                                                 ('Barbare',5,3,5,1),
                                                                                 ('Magichat',1,3,2,5),
                                                                                 ('Wizard',2,5,3,2),
                                                                                 ('Rogue',3,3,3,3)
...
CREATE TABLE Personnage (
                            ...
                            CONSTRAINT Compte_id_compte_FK    FOREIGN KEY ( id_compte) REFERENCES Compte(id_compte)
);
INSERT INTO Personnage (nom_personnage,id_classe,id_arme,date_creation,niveau,id_compte) VALUES
                                                                                             ...
                                                                                             ('ChatGratte',3,3,'2023-05-29',1,2),
                                                                                             ('George',3,3,'2023-05-29',1,3),
                                                                                             ('Patate',3,3,'2023-05-29',1,4),
                                                                                             ('Cheese',3,3,'2023-05-29',1,5),
                                                                                             ('Bruh', 2, 1 , '2023-05-23',41,1),
                                                                                             ('Meh', 2, 1 , '2023-05-23',41,1),
                                                                                             ('Dafuq', 2, 1 , '2023-05-23',41,1);
